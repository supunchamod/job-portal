    ...
    <!-- ======================= dashboard Detail ======================== -->
					...
					<div class="dashboard-nav">
						...
						<div class="dashboard-inner">
							<ul data-submenu-title="Main Navigation">
								...
								<li class="active"><a href="candidate-change-password.html"><i class="fa-solid fa-unlock-keyhole me-2"></i>Change Password</a></li>
							...
							<div class="colxl-12 col-lg-12 col-md-12">
								...
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb">
										...
										<li class="breadcrumb-item"><a href="#" class="text-primary">Change Password</a></li>
									</ol>
								</nav>
							</div>
						</div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('candidate.password.change') }}">
                        @csrf
                        @method('PUT')
